    ...
    <PageShell>
      <section className="py-20 lg:py-28">
        <Container className="space-y-12">
          ...
          {isClerkConfigured() ? <div className="flex justify-center"><SignUp path="/sign-up" routing="path" signInUrl="/login" /></div> : <AuthPlaceholder title="Clerk configuration is required" description="The sign-up route is ready for Clerk once you add local development credentials." />}
        </Container>
      </section>
    </PageShell>
  );
